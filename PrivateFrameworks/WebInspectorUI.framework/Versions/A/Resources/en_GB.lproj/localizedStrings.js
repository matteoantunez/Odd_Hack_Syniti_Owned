...
localizedStrings["%d \xd7 %d pixels"] = "%d × %d pixels";
localizedStrings["%d \xd7 %d pixels (Natural: %d \xd7 %d pixels)"] = "%d × %d pixels (Natural: %d × %d pixels)";
...
localizedStrings["(uninitialized)"] = "(uninitialised)";
localizedStrings[", "] = ", ";
...
localizedStrings["Alternate Glyphs @ Font Details Sidebar Property"] = "Alternative Glyphs";
...
localizedStrings["Animation Frame %d Canceled"] = "Animation Frame %d Cancelled";
...
localizedStrings["Animation Frame Canceled"] = "Animation Frame Cancelled";
...
localizedStrings["Canceled"] = "Cancelled";
...
localizedStrings["Checked"] = "Ticked";
...
localizedStrings["Click to select a color"] = "Click to select a colour";
localizedStrings["Click to select a color\nShift-click to switch color formats"] = "Click to select a colour\nShift-click to switch colour formats";
...
localizedStrings["Colors @ Computed Style variables section"] = "Colours";
...
localizedStrings["Contextual Alternates @ Font Details Sidebar Property Value"] = "Contextual Alternatives";
...
localizedStrings["Edge of sRGB color space"] = "Edge of sRGB colour space";
...
localizedStrings["Ensure that \u0022%s\u0022 is spelled correctly."] = "Ensure \"%s\" is spelt correctly.";
localizedStrings["Ensure that buttons have accessible labels for assistive technology."] = "Ensure buttons have accessible labels for assistive technology.";
localizedStrings["Ensure that dialogs have accessible labels for assistive technology."] = "Ensure dialogues have accessible labels for assistive technology.";
localizedStrings["Ensure that elements of role \u0022%s\u0022 and \u0022%s\u0022 have required owned elements in accordance with WAI-ARIA."] = "Ensure elements of role \"%s\" and \"%s\" have required owned elements in accordance with WAI-ARIA.";
localizedStrings["Ensure that elements of role \u0022%s\u0022 have accessible labels for assistive technology."] = "Ensure elements of role \"%s\" have accessible labels for assistive technology.";
localizedStrings["Ensure that elements of role \u0022%s\u0022 have required owned elements in accordance with WAI-ARIA."] = "Ensure elements of role \"%s\" have required owned elements in accordance with WAI-ARIA.";
localizedStrings["Ensure that links have accessible labels for assistive technology."] = "Ensure links have accessible labels for assistive technology.";
localizedStrings["Ensure that only one banner is used on the page."] = "Ensure only one banner is used on the page.";
localizedStrings["Ensure that only one live region is used on the page."] = "Ensure only one live region is used on the page.";
localizedStrings["Ensure that only one main content section is used on the page."] = "Ensure only one main content section is used on the page.";
localizedStrings["Ensure that values for \u0022%s\u0022 are valid."] = "Ensure values for \"%s\" are valid.";
...
localizedStrings["Format: Color Function"] = "Format: Colour Function";
...
localizedStrings["Periods of high CPU utilization will rapidly drain battery. Strive to keep idle pages under %s average CPU utilization."] = "Periods of high CPU utilisation will rapidly drain battery. Strive to keep idle pages under %s average CPU utilisation.";
...
localizedStrings["Screen Shot %s-%s-%s at %s.%s.%s"] = "Screenshot %s-%s-%s at %s.%s.%s";
...
localizedStrings["Scripts can also be individually blackboxed by clicking on the %s icon that is shown on hover."] = "Scripts can also be individually blackboxed by clicking the %s icon that is shown on hover.";
...
localizedStrings["Show property syntax in documentation popover"] = "Show property syntax in documentation pop-over";
...
localizedStrings["These are all of the different test result levels."] = "These are all the different test result levels.";
localizedStrings["These are example tests that demonstrate all of the different types of data that can be returned with the test result."] = "These are example tests that demonstrate all the different types of data that can be returned with the test result.";
...
localizedStrings["To improve CPU utilization reduce or batch workloads when the page is not visible or during times when the page is not being interacted with."] = "To improve CPU utilisation, reduce or batch workloads when the page is not visible or during times when the page is not being interacted with.";
...
localizedStrings["\u0022%s\u0022 is not JSON serializable"] = "\"%s\" is not JSON serialisable";
...
localizedStrings["popup"] = "pop-up";
localizedStrings["popup, toggle"] = "pop-up, toggle";
